...
class ConfigManager:
    ...
    def get_model_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "default_model": model_section.get(
                "default_model",
    ...
    def get_paths_config(self) -> Dict[str, str]:
        ...
        return {
            ...
            "original_dir": paths_section.get(
                "original_dir", "SphinxAI/models/original"
            ),
            "openvino_dir": paths_section.get(
                "openvino_dir", "SphinxAI/models/openvino"
            ),
            "compressed_dir": paths_section.get(
    ...
    def get_sphinx_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "searchd_pid": sphinx_section.get(
